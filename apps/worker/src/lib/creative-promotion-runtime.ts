...
export function normalizeCreativePromotionInput(args: Record<string, unknown>): CreativePromotionInput {
  ...
  return {
    ...
    callToAction: readString(args.callToAction) as CreativePromotionInput["callToAction"] | undefined,
    ...
    objective: readString(args.objective) as CreativePromotionInput["objective"] | undefined,
    ...
    customEventType: readString(args.customEventType) as CreativePromotionInput["customEventType"] | undefined,
    ...
    urgency: readString(args.urgency) as CreativePromotionInput["urgency"] | undefined,
  };
}
